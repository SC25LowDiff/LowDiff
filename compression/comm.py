...
class Communicator:
    def __init__(self, model, k=0.01, num_threads=None):
        """
        Initialize AsyncTopKCompressor with a compression ratio k.
        """
        self.k = k
        self.model = model
    ...
    def decompress(self):
        ...
        def process_gradient(param, data):
            ...
            for idx, val in zip(data["gathered_indices"], data["gathered_values"]):
                restored_grad.scatter_add_(0, idx, val)  # This remains a CPU/GPU task
