...
# Get the parent directory (i.e., the torch folder) of the absolute path of the current file (train.py)
current_dir = Path(__file__).resolve().parent
# Calculate the project root directory (project/)
...
def main():
    ...
    set_seed(42 + rank)  # Set a deterministic seed
    ...
    # Initialize the model (enable gradient checkpointing to save GPU memory)
    print("Loading model...")
    if args.model == 'gpt2':
